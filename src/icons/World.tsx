...
export const World: React.NamedExoticComponent<object> = React.memo(function (): JSX.Element {
  const size = 20;
  ...
  return (
    <Svg svgProps={svgProps}>
      ...
      <line className={line} x1={-hlines.x} y1={hlines.y} x2={hlines.x} y2={hlines.y} />
      <line className={line} x1={-hlines.x} y1={-hlines.y} x2={hlines.x} y2={-hlines.y} />
    </Svg>
  );
});
